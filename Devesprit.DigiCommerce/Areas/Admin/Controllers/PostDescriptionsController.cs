...
namespace Devesprit.DigiCommerce.Areas.Admin.Controllers
{
    ...
    [UserHasPermission("ManagePostDescriptions")]
    public partial class PostDescriptionsController : BaseController
    {
        ...
        [UserHasAtLeastOnePermission("ManagePostDescriptions_Add", "ManagePostDescriptions_Edit")]
        ...
        public virtual async Task<ActionResult> Editor(PostDescriptionModel model, bool? saveAndContinue)
        {
            ...
            try
            {
                if (model.Id == null)
                {
                    if (!HttpContext.UserHasPermission("ManagePostDescriptions_Add"))
                    {
                ...
                {
                    if (!HttpContext.UserHasPermission("ManagePostDescriptions_Edit"))
                    {
                        return View("AccessPermissionError");
                    }
        ...
        [HttpPost]
        [UserHasPermission("ManagePostDescriptions_Delete")]
