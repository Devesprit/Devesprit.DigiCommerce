...
namespace Devesprit.Core
{
    public partial class TypeFinder : ITypeFinder
    {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^Antlr3|^Autofac|^AutoMapper|^EntityFramework|^Dapper|^DotNetZip|^Elmah|^MvcContrib|^Newtonsoft|^Hangfire|^HibernatingRhinos|^JetBrains|^Lucene|^reCaptcha|^Scriban|^Syncfusion|^X.PagedList|^Z.EntityFramework|^Z.ExtensionMethods|^WebActivator|^WebDev|^WebGrease";
