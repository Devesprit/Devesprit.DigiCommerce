...
{
    public partial class AdminPanelBlogPostService : PostService<TblBlogPosts>, IAdminPanelBlogPostService
    {
        public AdminPanelBlogPostService(AppDbContext dbContext,
